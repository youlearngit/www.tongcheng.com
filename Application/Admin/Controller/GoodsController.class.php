...
class GoodsController extends Controller {
    ...
    public function insert(){
        ...
        if($res){
            ...
            $this->error('添加成功',U("Admin/Goods/index"),2);
    ...
    public function update(){
        ...
        if($res){
            ...
            $this->error('修改成功',U("Admin/Goods/index"),2);
    ...
    public function delete(){
        ...
        if($res){
            ...
            $this->error('删除成功',U("Admin/Goods/index"),2);
    ...
    public function hui(){
        ...
        if($res){
            ...
            $this->error('还原成功',U("Admin/Goods/index"),2);
